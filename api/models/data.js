...
module.exports = function(db, User, Quiz, Category, Question, Answer) {
    ...
    db.once('open', function() {
        ...
        db1Q1._answers.push(db1A1._id, db1A2._id, db1A3._id, db1A4._id);
        db1Q2._answers.push(db1A5._id, db1A6._id, db1A7._id, db1A8._id);
        db1Q3._answers.push(db1A9._id, db1A10._id, db1A11._id, db1A12._id);
        db1Q4._answers.push(db1A13._id, db1A14._id, db1A15._id, db1A16._id);
        db1Q5._answers.push(db1A17._id, db1A18._id, db1A19._id, db1A20._id);
        db1Q6._answers.push(db1A21._id, db1A22._id, db1A23._id, db1A24._id);
        db1Q7._answers.push(db1A25._id, db1A26._id, db1A27._id, db1A28._id);
        db1Q8._answers.push(db1A29._id, db1A30._id, db1A31._id, db1A32._id);
        db1Q9._answers.push(db1A33._id, db1A34._id, db1A35._id, db1A36._id);
        db1Q10._answers.push(db1A37._id, db1A38._id, db1A39._id, db1A40._id);
        db1Q11._answers.push(db1A41._id, db1A42._id, db1A43._id, db1A44._id);
        db1Q12._answers.push(db1A45._id, db1A46._id, db1A47._id, db1A48._id);

        db1._questions.push(db1Q1._id);
        db1._questions.push(db1Q2._id);
        db1._questions.push(db1Q3._id);
        db1._questions.push(db1Q4._id);
        db1._questions.push(db1Q5._id);
        db1._questions.push(db1Q6._id);
        db1._questions.push(db1Q7._id);
        db1._questions.push(db1Q8._id);
        db1._questions.push(db1Q9._id);
        db1._questions.push(db1Q10._id);
        db1._questions.push(db1Q11._id);
        db1._questions.push(db1Q12._id);
        ...
        wi1Q1._answers.push(wi1A1._id, wi1A2._id, wi1A3._id, wi1A4._id);
        wi1Q2._answers.push(wi1A5._id, wi1A6._id, wi1A7._id, wi1A8._id);
        wi1Q3._answers.push(wi1A9._id, wi1A10._id, wi1A11._id, wi1A12._id);
        wi1Q4._answers.push(wi1A13._id, wi1A14._id, wi1A15._id, wi1A16._id);
        wi1Q5._answers.push(wi1A17._id, wi1A18._id, wi1A19._id, wi1A20._id);
        wi1Q6._answers.push(wi1A21._id, wi1A22._id, wi1A23._id, wi1A24._id);
        wi1Q7._answers.push(wi1A25._id, wi1A26._id, wi1A27._id, wi1A28._id);
        wi1Q8._answers.push(wi1A29._id, wi1A30._id, wi1A31._id, wi1A32._id);
        wi1Q9._answers.push(wi1A33._id, wi1A34._id, wi1A35._id, wi1A36._id);
        wi1Q10._answers.push(wi1A37._id, wi1A38._id, wi1A39._id, wi1A40._id);
        wi1Q11._answers.push(wi1A41._id, wi1A42._id, wi1A43._id, wi1A44._id);
        wi1Q12._answers.push(wi1A45._id, wi1A46._id, wi1A47._id, wi1A48._id);

        wi1._questions.push(wi1Q1._id);
        wi1._questions.push(wi1Q2._id);
        wi1._questions.push(wi1Q3._id);
        wi1._questions.push(wi1Q4._id);
        wi1._questions.push(wi1Q5._id);
        wi1._questions.push(wi1Q6._id);
        wi1._questions.push(wi1Q7._id);
        wi1._questions.push(wi1Q8._id);
        wi1._questions.push(wi1Q9._id);
        wi1._questions.push(wi1Q10._id);
        wi1._questions.push(wi1Q11._id);
        wi1._questions.push(wi1Q12._id);
        ...
        cn1Q1._answers.push(cn1A1._id, cn1A2._id, cn1A3._id, cn1A4._id);
        cn1Q2._answers.push(cn1A5._id, cn1A6._id, cn1A7._id, cn1A8._id);
        cn1Q3._answers.push(cn1A9._id, cn1A10._id, cn1A11._id, cn1A12._id);
        cn1Q4._answers.push(cn1A13._id, cn1A14._id, cn1A15._id, cn1A16._id);
        cn1Q5._answers.push(cn1A17._id, cn1A18._id, cn1A19._id, cn1A20._id);
        cn1Q6._answers.push(cn1A21._id, cn1A22._id, cn1A23._id, cn1A24._id);
        cn1Q7._answers.push(cn1A25._id, cn1A26._id, cn1A27._id, cn1A28._id);
        cn1Q8._answers.push(cn1A29._id, cn1A30._id, cn1A31._id, cn1A32._id);
        cn1Q9._answers.push(cn1A33._id, cn1A34._id, cn1A35._id, cn1A36._id);
        cn1Q10._answers.push(cn1A37._id, cn1A38._id, cn1A39._id, cn1A40._id);
        cn1Q11._answers.push(cn1A41._id, cn1A42._id, cn1A43._id, cn1A44._id);
        cn1Q12._answers.push(cn1A45._id, cn1A46._id, cn1A47._id, cn1A48._id);

        cn1._questions.push(cn1Q1._id);
        cn1._questions.push(cn1Q2._id);
        cn1._questions.push(cn1Q3._id);
        cn1._questions.push(cn1Q4._id);
        cn1._questions.push(cn1Q5._id);
        cn1._questions.push(cn1Q6._id);
        cn1._questions.push(cn1Q7._id);
        cn1._questions.push(cn1Q8._id);
        cn1._questions.push(cn1Q9._id);
        cn1._questions.push(cn1Q10._id);
        cn1._questions.push(cn1Q11._id);
        cn1._questions.push(cn1Q12._id);
        ...
        infsi1Q1._answers.push(infsi1A1._id, infsi1A2._id, infsi1A3._id, infsi1A4._id);
        infsi1Q2._answers.push(infsi1A5._id, infsi1A6._id, infsi1A7._id, infsi1A8._id);
        infsi1Q3._answers.push(infsi1A9._id, infsi1A10._id, infsi1A11._id, infsi1A12._id);
        infsi1Q4._answers.push(infsi1A13._id, infsi1A14._id, infsi1A15._id, infsi1A16._id);
        infsi1Q5._answers.push(infsi1A17._id, infsi1A18._id, infsi1A19._id, infsi1A20._id);
        infsi1Q6._answers.push(infsi1A21._id, infsi1A22._id, infsi1A23._id, infsi1A24._id);
        infsi1Q7._answers.push(infsi1A25._id, infsi1A26._id, infsi1A27._id, infsi1A28._id);
        infsi1Q8._answers.push(infsi1A29._id, infsi1A30._id, infsi1A31._id, infsi1A32._id);
        infsi1Q9._answers.push(infsi1A33._id, infsi1A34._id, infsi1A35._id, infsi1A36._id);
        infsi1Q10._answers.push(infsi1A37._id, infsi1A38._id, infsi1A39._id, infsi1A40._id);
        infsi1Q11._answers.push(infsi1A41._id, infsi1A42._id, infsi1A43._id, infsi1A44._id);
        infsi1Q12._answers.push(infsi1A45._id, infsi1A46._id, infsi1A47._id, infsi1A48._id);

        infsi1._questions.push(infsi1Q1._id);
        infsi1._questions.push(infsi1Q2._id);
        infsi1._questions.push(infsi1Q3._id);
        infsi1._questions.push(infsi1Q4._id);
        infsi1._questions.push(infsi1Q5._id);
        infsi1._questions.push(infsi1Q6._id);
        infsi1._questions.push(infsi1Q7._id);
        infsi1._questions.push(infsi1Q8._id);
        infsi1._questions.push(infsi1Q9._id);
        infsi1._questions.push(infsi1Q10._id);
        infsi1._questions.push(infsi1Q11._id);
        infsi1._questions.push(infsi1Q12._id);
        ...
        allgHSRQ1._answers.push(allgHSRA1._id, allgHSRA2._id, allgHSRA3._id, allgHSRA4._id);
        allgHSRQ2._answers.push(allgHSRA5._id, allgHSRA6._id, allgHSRA7._id, allgHSRA8._id);
        allgHSRQ3._answers.push(allgHSRA9._id, allgHSRA10._id, allgHSRA11._id, allgHSRA12._id);
        allgHSRQ4._answers.push(allgHSRA13._id, allgHSRA14._id, allgHSRA15._id, allgHSRA16._id);
        allgHSRQ5._answers.push(allgHSRA17._id, allgHSRA18._id, allgHSRA19._id, allgHSRA20._id);
        allgHSRQ6._answers.push(allgHSRA21._id, allgHSRA22._id, allgHSRA23._id, allgHSRA24._id);
        allgHSRQ7._answers.push(allgHSRA25._id, allgHSRA26._id, allgHSRA27._id, allgHSRA28._id);
        allgHSRQ8._answers.push(allgHSRA29._id, allgHSRA30._id, allgHSRA31._id, allgHSRA32._id);
        allgHSRQ9._answers.push(allgHSRA33._id, allgHSRA34._id, allgHSRA35._id, allgHSRA36._id);
        allgHSRQ10._answers.push(allgHSRA37._id, allgHSRA38._id, allgHSRA39._id, allgHSRA40._id);
        allgHSRQ11._answers.push(allgHSRA41._id, allgHSRA42._id, allgHSRA43._id, allgHSRA44._id);
        allgHSRQ12._answers.push(allgHSRA45._id, allgHSRA46._id, allgHSRA47._id, allgHSRA48._id);

        allgHSR._questions.push(allgHSRQ1._id);
        allgHSR._questions.push(allgHSRQ2._id);
        allgHSR._questions.push(allgHSRQ3._id);
        allgHSR._questions.push(allgHSRQ4._id);
        allgHSR._questions.push(allgHSRQ5._id);
        allgHSR._questions.push(allgHSRQ6._id);
        allgHSR._questions.push(allgHSRQ7._id);
        allgHSR._questions.push(allgHSRQ8._id);
        allgHSR._questions.push(allgHSRQ9._id);
        allgHSR._questions.push(allgHSRQ10._id);
        allgHSR._questions.push(allgHSRQ11._id);
        allgHSR._questions.push(allgHSRQ12._id);
        ...
        cat1Q1._answers.push(cat1A1._id, cat1A2._id, cat1A3._id, cat1A4._id);
        cat1Q2._answers.push(cat1A5._id, cat1A6._id, cat1A7._id, cat1A8._id);
        cat1Q3._answers.push(cat1A9._id, cat1A10._id, cat1A11._id, cat1A12._id);
        cat1Q4._answers.push(cat1A13._id, cat1A14._id, cat1A15._id, cat1A16._id);
        cat1Q5._answers.push(cat1A17._id, cat1A18._id, cat1A19._id, cat1A20._id);
        cat1Q6._answers.push(cat1A21._id, cat1A22._id, cat1A23._id, cat1A24._id);
        cat1Q7._answers.push(cat1A25._id, cat1A26._id, cat1A27._id, cat1A28._id);
        cat1Q8._answers.push(cat1A29._id, cat1A30._id, cat1A31._id, cat1A32._id);
        cat1Q9._answers.push(cat1A33._id, cat1A34._id, cat1A35._id, cat1A36._id);
        cat1Q10._answers.push(cat1A37._id, cat1A38._id, cat1A39._id, cat1A40._id);
        cat1Q11._answers.push(cat1A41._id, cat1A42._id, cat1A43._id, cat1A44._id);
        cat1Q12._answers.push(cat1A45._id, cat1A46._id, cat1A47._id, cat1A48._id);

        cat1._questions.push(cat1Q1._id);
        cat1._questions.push(cat1Q2._id);
        cat1._questions.push(cat1Q3._id);
        cat1._questions.push(cat1Q4._id);
        cat1._questions.push(cat1Q5._id);
        cat1._questions.push(cat1Q6._id);
        cat1._questions.push(cat1Q7._id);
        cat1._questions.push(cat1Q8._id);
        cat1._questions.push(cat1Q9._id);
        cat1._questions.push(cat1Q10._id);
        cat1._questions.push(cat1Q11._id);
        cat1._questions.push(cat1Q12._id);
